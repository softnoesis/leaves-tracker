      ...
      <div id="wrapper">
         ...
         <div id="content-wrapper">
            <div class="container-fluid">
               ...
               <h3><b><?php echo strtoupper($profile->name);  ?></h3>
               <h6><b><?php echo strtoupper($profile->designation); ?></h6> 
               ...
               <div class="form-row">
                  <div class="col-md-6">
                     ...
                     <div class="form-label-group">
                        <input type="file" id="profile_image" onchange="readURL(this);" name="profile_image">
                        <img id="imagedisplay" src="<?php echo base_url()?>image/<?php echo $image;?>" style="height: auto;border-radius: 100px; width: 100px;"/>
                        <img id="blah" src="#" style="height: auto;border-radius: 100px; width: 100px; display: none;" />
                     </div>
                  </div>
               </div>
            </div>
