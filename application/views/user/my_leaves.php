   ...
   <body id="page-top">
                  ...
                  <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                     ...
                     <tbody>
                        <?php
                           ...
                           foreach ($leaves as $row_leaves) :
                            ...
                            if($row_leaves->half_day == 0)
                            {
                                ...
                                $end_date_s = $row_leaves->startdate;
                            }
                            else
                            {
                        ...
                        <tr>
                          ...
                          <td><?php echo htmlentities(date('M j, Y', strtotime($row_leaves->startdate)).', '.date('l', strtotime($row_leaves->startdate)))?></td>
                          <td><?php echo htmlentities(date('M j, Y', strtotime($end_date_s)).', '.date('l', strtotime($end_date_s)))?></td>
                          ...
                          <?php if($row_leaves->leave_status == 0) {?>
                            <a title="Cancel Leave" href="<?php echo site_url()?>admin/member/updatedata/<?php echo $row_leaves->id;?>" data-getueid="<?php echo $row_leaves->id;?>" id="update-emp-details" data-toggle="modal" data-target="#editAdmin_member_Model">
                              <button class="cls_accept">Cancel</button>
                            </a>
                            <a title="Edit" href="<?php echo site_url()?>admin/member/updatedata/<?php echo $row_leaves->id;?>" data-getueid="<?php echo $row_leaves->id;?>" id="edit-emp-details" data-toggle="modal" data-target="#edituser_member_Model">
                              <button class="cls_reject">Edit</button>
                            </a>
      ...
      <!-- /.content-wrapper -->
         	...
         	<div class="modal-dialog">
	            <div class="modal-content">
	               <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
	                  echo form_open_multipart("user/User_Profile/cancel_leave", $attrib); ?>
      	...
      	<div id="edituser_member_Model" class="modal fade">
         	<div class="modal-dialog">
	            <div class="modal-content">
	               <form method="post" enctype="multipart/form-data" action="<?php echo site_url()?>user/User_Profile/edit_leave">
	                  <div class="modal-header">
...
<script type="text/javascript">
  ...
  jQuery(document).on('click', '#update-emp-details', function(){
    ...
    $.ajax({
       type: "post",
       async: false,
       url: "<?php echo base_url('user/User_Profile/getReason'); ?>",
       dataType: "json",
       data : {"id" : id},
