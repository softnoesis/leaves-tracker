                ...
                <tbody>
                  <?php
                     ...
                     foreach ($attendance as $row_attendance) {?>
                      <tr>
                        <input type="hidden" name="emp_name" id="emp_name" value="<?php echo $row_attendance->employee_name; ?>">
...
<script type="text/javascript">
  $(document).on('change','#month_year_drop',function(){
      ...
      var emp_name = $("#emp_name").val();
        jQuery.ajax({
        type:"post",
        url: "<?php echo base_url(); ?>user/attendance/getAttendanceData",
        data:{ 'month_name':month_name,'company_id':company_id,'emp_name':emp_name},
        success: function(response) {
          response = $.parseJSON(response);
          var final_count = 0; var cls_html_foot = ""; var cls_html_list = ""; var present_day = 0; var absent_day = 0;  var total_ot = 0; var total_leave = 0; var total_present = 0; var pay_days = 0;
