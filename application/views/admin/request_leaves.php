    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <div class="container">
            <form action="<?php echo base_url('admin/Member/requestleaveinsert'); ?>" method="Post">
              <div class="row">
                <div class="col-25">
              ...
              <div class="row" id="halfday">
                <div class="col-25">
                  <label for="fname" class="labe1">Dureation:</label>
                </div>
                <div class="col-75">
                  <label for="male">Half Day</label>
                  <input type="radio" id="half_day" name="half_day" value="0" onchange="myFunction()"></br>
              ...
              <div class="row" id="clockpicker" style="display: none;">
                ...
                <div class="col-75">
                  ...
                  <label for="time" style="margin-left: 10px;">End Time</label>
